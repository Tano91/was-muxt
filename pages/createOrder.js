      ...
      <Fade in timeout={500}>
        ...
        <Container>
          ...
          >
            ...
            <TextField
              error={
                videographerError && videographerError.length ? true : false
              }
              id="videographer"
              required
              select
            ...
            <TextField
              error={
                bookingNumberError && bookingNumberError.length ? true : false
              }
              id="booking-number"
              required
            ...
            <TextField
              error={
                receiptNumberError && receiptNumberError.length ? true : false
              }
              id="receipt-number"
              required
            ...
            <TextField
              error={
                groomFirstNameError && groomFirstNameError.length ? true : false
              }
              id="groom-first"
              required
            ...
            <TextField
              error={
                groomLastNameError && groomLastNameError.length ? true : false
              }
              id="groom-last"
              required
            ...
            <TextField
              error={
                brideFirstNameError && brideFirstNameError.length ? true : false
              }
              id="bride-first"
              required
            ...
            <TextField
              error={
                brideLastNameError && brideLastNameError.length ? true : false
              }
              id="bride-last"
              required
